...
### API Examples
- [DAIZYX402 - AI Security Research API](https://www.daizyx402.com) - Smart contract vulnerability research powered by Aetheris on Base Mainnet. $0.05 USDC per research query, $0.50 USDC for deep analyst report. x402 Protocol · No Signup · No API Keys.
